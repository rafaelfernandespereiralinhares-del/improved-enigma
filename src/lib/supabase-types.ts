...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      manutencoes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "manutencoes_loja_id_fkey"
            columns: ["loja_id"]
            isOneToOne: false
            referencedRelation: "lojas"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      auditoria_status: "Aberto" | "Concluido"
      campanha_tipo: "MENSAL" | "SEMANAL" | "DIARIA"
      conciliacao_status: "Pendente" | "Conciliado" | "Divergente"
      conta_pagar_status: "Pendente" | "Pago" | "Atrasado"
      conta_receber_status: "Pendente" | "Recebido" | "Atrasado" | "Negociado"
      custo_casa_status: "Pendente" | "Pago"
      etapa_cobranca: "Preventiva" | "Cobranca 1" | "Cobranca 2" | "Juridico" | null
      fechamento_status: "Aberto" | "Fechado" | "Conferido"
      tipo_pagamento_maquina: "Credito" | "Debito" | "Pix"
      vinculo_tipo: "CLT" | "PJ" | "Freelancer"
    }
    CompositeTypes: {
      [_ in never]: never
    }
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["ADMIN", "DIRETORIA", "FINANCEIRO", "LOJA"],
      auditoria_status: ["Aberto", "Concluido"],
      campanha_tipo: ["Produto", "Servico", "Combo"],
      conciliacao_status: ["Pendente", "Conciliado", "Divergente"],
      conta_pagar_status: ["Pendente", "Pago", "Atrasado"],
      conta_receber_status: ["Pendente", "Recebido", "Atrasado", "Negociado"],
      custo_casa_status: ["Pendente", "Pago"],
